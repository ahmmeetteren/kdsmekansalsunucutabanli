...
$kar_sorgu = mysqli_query($baglanti,"SELECT SUM(dep_ay.kar) as kar FROM departmanlar,dep_ay,aylar WHERE aylar.ay_id = dep_ay.ay_id AND dep_ay.dep_id = departmanlar.dep_id GROUP BY ay_ad");
?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <div class="content">
			...
			<div class="informations">
				...
				<div class="box">
					...
					<span class= "box-span" id="box-span1">10 Toplam Personel</span>
				</div>
				<div class="box">
					<div class="box-header"><h5>Müşteri Değerlendirme Ortalaması</h5></div>
