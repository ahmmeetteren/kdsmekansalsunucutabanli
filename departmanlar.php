...
$kar_sorgu = mysqli_query($baglanti,"SELECT SUM(dep_ay.kar) as kar FROM departmanlar,dep_ay WHERE departmanlar.dep_id=dep_ay.dep_id GROUP BY departmanlar.dep_ad");
$maas_sorgu=mysqli_query($baglanti,"SELECT SUM(personel.per_maas) as maas_toplam FROM departmanlar,personel WHERE departmanlar.dep_id=personel.dep_id GROUP BY departmanlar.dep_ad");
$gelir_gider=mysqli_query($baglanti,"SELECT(SELECT SUM(personel.per_maas) FROM personel,departmanlar WHERE departmanlar.dep_id=personel.dep_id) AS gider,(SELECT SUM(dep_ay.kar)FROM dep_ay,departmanlar WHERE dep_ay.dep_id=departmanlar.dep_id)AS gelir");
$gelir_gider2=mysqli_query($baglanti,"SELECT(SELECT SUM(personel.per_maas) FROM personel,departmanlar WHERE departmanlar.dep_id=personel.dep_id) AS gider,(SELECT SUM(dep_ay.kar)FROM dep_ay,departmanlar WHERE dep_ay.dep_id=departmanlar.dep_id)AS gelir");
        ...
        <div class="content">
			...
			<div class="charts">
				<div class="chart-container">
					<h5>Departmanların 2020 Yılı Toplam Geliri</h5>
				...
				<div class="chart-container">
					<h5>Departmanların 2020 Yılı Toplam Gideri</h5>
