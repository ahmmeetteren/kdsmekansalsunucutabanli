    ...
    <body>
        ...
        <div class="content">
			...
			<div class="form-container">
				...
				<?php
					if($baglanti){
						$sorgu = $baglanti->query("SELECT personel.per_id, personel.per_ad, personel.per_soyad, departmanlar.dep_ad, personel.per_maas, puan.verimlilik_puan FROM personel, puan, departmanlar WHERE personel.per_id=puan.per_id AND personel.dep_id=departmanlar.dep_id");
					}else{
